...
for file_path in file_list:
    ...
    latitude_column = df['LATITUDE']  # Extract the "LATITUDE" column
    longitude_column = df['LONGITUDE']
    lat.extend(latitude_column.tolist())  # Add the column values to the list
    lon.extend(longitude_column.tolist())
print(lat)
print(lon)
